...
class PetRepository(context: Context) {
    ...
    suspend fun submitSightingAlert(
        ...
        // Automatically create or update chat session
        ...
        val systemMsg = ChatMessageEntity(
            ...
            text = "🚨 ALERTA DE AVISTAMIENTO EN TIEMPO REAL\n📍 Ubicación: $locationName ($latitude, $longitude)\n📝 Nota: $notes",
            photoUri = photoUri,
            timestamp = timestamp,
    ...
    suspend fun toggleChatContactSharing(chatId: String, isShared: Boolean, ownerName: String, phone: String, email: String) {
        ...
        val text = if (isShared) {
            "🔓 $ownerName ha AUTORIZADO la visualización de sus datos de contacto:\n📞 Teléfono: $phone\n✉️ Email: $email"
        } else {
            "🔒 $ownerName ha revocó el acceso a sus datos de contacto."
        }
    ...
    suspend fun seedInitialDataIfNeeded() {
        ...
        if (existingPosts.isEmpty()) {
            ...
            // Seed an initial sighting alert for Max
