...
| --- | --- | --- | --- |
| Informacion personal | Nombre visible, email de cuenta, telefono/email de contacto configurado | Cuenta, perfil, contacto autorizado | Firebase Authentication, Cloud Firestore |
...
| Mensajes | Conversaciones privadas y metadata de chat | Comunicacion entre participantes autorizados | Cloud Firestore |
