...
FindYourPet ayuda a publicar mascotas perdidas y reportar avistamientos. Esta politica describe los datos que trata la app en su primera publicacion controlada para Google Play Internal testing.
...
- Datos de moderacion: reportes de contenido y relaciones de bloqueo asociadas a avistamientos.
...
- Mantener el historial de avistamientos y las acciones de moderacion autorizadas.
- Avisar dentro de la app sobre avistamientos.
...
- Notificaciones: mostrar avisos locales de avistamientos cuando el usuario concede el permiso.

Si un permiso se deniega, la app debe permitir continuar con alternativas manuales cuando el flujo lo admita.

## Contacto, ubicacion y datos historicos

FindYourPet no ofrece mensajeria ni solicita o comparte telefono, email, direccion u otros datos personales de contacto entre usuarios. Los documentos remotos historicos de Chat pueden conservarse por retencion, pero la app actual no los abre, modifica ni crea.
...
- Cloud Firestore: almacenamiento de publicaciones, avistamientos, moderacion, perfiles y notificaciones; los documentos historicos de Chat se conservan sin nuevos writes.
